...
import { Table, Card, Space, Button, Input, Select, DatePicker, Tag, Row, Col, Tooltip, Modal, Spin, Typography, notification, Popconfirm, Radio, Checkbox, Flex, Tabs, Badge, Avatar, Rate, Menu, Dropdown, Alert } from 'antd';
import { SearchOutlined, EditOutlined, EyeOutlined, ExportOutlined, FilterOutlined, ReloadOutlined, DownloadOutlined, UserOutlined, TeamOutlined, CalendarOutlined, FileTextOutlined, CheckCircleFilled, ExclamationCircleOutlined, FrownOutlined, MehOutlined, SmileOutlined, MoreOutlined, BarChartOutlined, FormOutlined, AppstoreOutlined, CaretDownOutlined, SettingOutlined } from '@ant-design/icons';
                    ...
                    label: (
                      <div onClick={handleMenuClick}>
                        <Checkbox
                          ...
                          onChange={() => handleColumnVisibilityChange("surveyDate")}
                        >
                          Survey Date
                        </Checkbox>
                      </div>
                    ...
                    label: (
                      <div onClick={handleMenuClick}>
                        <Checkbox
                          ...
                          onChange={() => handleColumnVisibilityChange("rating")}
                        >
                          Rating
                        </Checkbox>
                      </div>
                    ...
                    label: (
                      <div onClick={handleMenuClick}>
                        <Checkbox
                          ...
                          onChange={() => handleColumnVisibilityChange("feedback")}
                        >
                          Feedback
                        </Checkbox>
                      </div>
      ...
      >
        ...
        >
          <div className="space-y-6">
            ...
            <div>
              <Typography.Title level={5}>Filter by Date Range</Typography.Title>
              <RangePicker 
                style={{ width: '100%' }}
            ...
            <div>
              ...
              <Radio.Group value={ratingFilter} onChange={(e) => setRatingFilter(e.target.value)}>
                <Space direction="vertical">
                  ...
                  <Radio value={5}>
                    <div className="flex items-center">
                      ...
                      <div className="ml-2 flex">
                        {[1, 2, 3, 4, 5].map(star => (
                          <SmileOutlined key={star} className="text-green-500" style={{ fontSize: 16 }} />
                        ))}
                      </div>
                    </div>
                  </Radio>
                  <Radio value={4}>
                    <div className="flex items-center">
                      ...
                      <div className="ml-2 flex">
                        {[1, 2, 3, 4].map(star => (
                          <SmileOutlined key={star} className="text-blue-500" style={{ fontSize: 16 }} />
                        ))}
                      </div>
                    </div>
                  </Radio>
                  <Radio value={3}>
                    <div className="flex items-center">
                      ...
                      <div className="ml-2 flex">
                        {[1, 2, 3].map(star => (
                          <MehOutlined key={star} className="text-yellow-500" style={{ fontSize: 16 }} />
                        ))}
                      </div>
                    </div>
                  </Radio>
                  <Radio value={2}>
                    <div className="flex items-center">
                      ...
                      <div className="ml-2 flex">
                        {[1, 2].map(star => (
                          <FrownOutlined key={star} className="text-orange-500" style={{ fontSize: 16 }} />
                        ))}
                      </div>
                    </div>
                  </Radio>
                  <Radio value={1}>
                    <div className="flex items-center">
                      ...
                      <div className="ml-2 flex">
                        <FrownOutlined className="text-red-500" style={{ fontSize: 16 }} />
                      </div>
                    </div>
                  </Radio>
                </Space>
            ...
            <div>
              ...
              >
                <Option value={SURVEY_STATUS.PENDING}>Pending</Option>
                <Option value={SURVEY_STATUS.SUBMITTED}>Submitted</Option>
                <Option value={SURVEY_STATUS.UPDATED}>Updated after submission</Option>
              </Select>
    </div>
          </div>
        </Modal>
