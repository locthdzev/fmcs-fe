  ...
  return (
    <div style={{ padding: '20px' }}>
      <Card className="welcome-card" style={{ marginBottom: '20px', borderRadius: '8px' }}>
        ...
        <Text>You are logged in as a Manager. You can manage staff, view reports, and oversee facility operations.</Text>
      </Card>
      ...
      <Row style={{ marginTop: '24px' }}>
        <Col span={24}>
          <Card 
            title={<Title level={4}><MedicineBoxOutlined /> Health Services Overview</Title>} 
            style={{ borderRadius: '8px' }}
          >
            <Row gutter={16}>
              <Col span={8}>
                <Card style={{ textAlign: 'center', borderRadius: '6px' }}>
                  <Title level={2} style={{ margin: 0, color: '#1890ff' }}>24</Title>
                  <Text>Appointments Today</Text>
                </Card>
              </Col>
              <Col span={8}>
                <Card style={{ textAlign: 'center', borderRadius: '6px' }}>
                  <Title level={2} style={{ margin: 0, color: '#52c41a' }}>5</Title>
                  <Text>Active Staff</Text>
                </Card>
              </Col>
              <Col span={8}>
                <Card style={{ textAlign: 'center', borderRadius: '6px' }}>
                  <Title level={2} style={{ margin: 0, color: '#722ed1' }}>98%</Title>
