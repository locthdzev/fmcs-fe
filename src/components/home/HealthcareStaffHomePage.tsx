...
const HealthcareStaffHomePage: React.FC = () => {
  ...
  useEffect(() => {
    if (
      ...
      !userContext.user.role.includes("Healthcare Staff")
    ) {
      antMessage.error({
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      >
        ...
        <Text>
          You are logged in as a Healthcare Staff member. You can manage
          appointments, prescriptions, and treatment plans.
        </Text>
      </Card>
