        ...
        return (
          <Card title="Insurance Status">
            <Form.Item
              ...
              rules={[{ required: true, message: 'Please select whether the user has insurance' }]}
            >
              <Radio.Group onChange={(e) => setHasInsurance(e.target.value)}>
                <Radio value={true}>Yes, user has health insurance</Radio>
                <Radio value={false}>No, user does not have health insurance</Radio>
              </Radio.Group>
            </Form.Item>
            <div className="mt-4">
              <Text type="secondary">
                  ...
                  <Row gutter={16}>
                    <Col span={24} md={12}>
                      <Form.Item
                        ...
                        rules={[{ required: true, message: 'Please enter health insurance number' }]}
                      >
                        <Input />
                      </Form.Item>
                    </Col>
            ...
            {hasInsurance ? (
              <>
                    ...
                    <Card title="Review Insurance Information" type="inner">
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                        <div>
                          ...
                          {users.find(u => u.id === form.getFieldValue('userId'))?.fullName} ({users.find(u => u.id === form.getFieldValue('userId'))?.email})
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          {form.getFieldValue('dateOfBirth')?.format('DD/MM/YYYY') || "-"}
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          {form.getFieldValue('healthcareProviderName')} {form.getFieldValue('healthcareProviderCode') ? `(${form.getFieldValue('healthcareProviderCode')})` : ""}
                        </div>
                        <div>
                          <strong>Valid From:</strong><br/>
                          {form.getFieldValue('validFrom')?.format('DD/MM/YYYY') || "-"}
                        </div>
                        <div>
                          <strong>Valid To:</strong><br/>
                          {form.getFieldValue('validTo')?.format('DD/MM/YYYY') || "-"}
                        </div>
                        <div>
                ...
                <div className="flex items-center justify-between">
                  <Text type="secondary">
                    Please review the information above before submitting. Once submitted, this user's health insurance information will be updated.
                  </Text>
                </div>
              </>
            ) : (
      ...
      <Card className="mb-4">
        <Steps
          ...
          items={[
            ...
            { title: "Information", description: hasInsurance ? "Enter details" : "Confirm" },
