...
const CreateModal: React.FC<CreateModalProps> = ({
  ...
  const handleCreate = async () => {
    try {
      ...
      if (response.isSuccess) {
        ...
        messageApi.error({ content: response.message || "Failed to create user", key: "createUser" });
      }
    } catch (error) {
      console.error("Error creating user:", error);
      messageApi.error({ content: "An error occurred while creating the user", key: "createUser" });
    } finally {
  ...
  return (
    ...
    >
      {contextHolder}
      <Spin spinning={loading} tip="Loading role data...">
